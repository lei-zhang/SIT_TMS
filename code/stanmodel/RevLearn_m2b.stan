// Fictitious RL + instantaneous social information
data {
...
model {
  ...
  for (s in 1:nSubjects) {    
    ...
    for (t in 1:nTrials) {
      ...
      valfun2_V = beta[2,s,1] + beta[3,s,1] * valdiff_V + beta[4,s,1] * wgtAgst_ms_V[s,t];
      ...
      valfun2_R = beta[2,s,2] + beta[3,s,2] * valdiff_R + beta[4,s,2] * wgtAgst_ms_R[s,t];
      ...
      valfun2_L = beta[2,s,3] + beta[3,s,3] * valdiff_L + beta[4,s,3] * wgtAgst_ms_L[s,t];
