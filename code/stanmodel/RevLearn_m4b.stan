...
data {
  ...
  real<lower=0,upper=1> wProb_sC2_V[nSubjects,nTrials,4];  // weighted prob based on preference' weight, same as my C2
  real<lower=0,upper=1> wProb_sC2_R[nSubjects,nTrials,4];
  real<lower=0,upper=1> wProb_sC2_L[nSubjects,nTrials,4];
  real<lower=0,upper=1> wProb_oC2_V[nSubjects,nTrials,4];  // weighted prob based on preference' weight, opposite to my C2
  real<lower=0,upper=1> wProb_oC2_R[nSubjects,nTrials,4];
  real<lower=0,upper=1> wProb_oC2_L[nSubjects,nTrials,4];  
}
...
model {
  ...
  for (s in 1:nSubjects) {    
    ...
    for (t in 1:nTrials) {
      ...
      otherValue_V[choice2_V[s,t]]   = sum( wProb_sC2_V[s,t] );
      otherValue_V[3-choice2_V[s,t]] = sum( wProb_oC2_V[s,t] );
      ...
      otherValue_R[choice2_R[s,t]]   = sum( wProb_sC2_R[s,t] );
      otherValue_R[3-choice2_R[s,t]] = sum( wProb_oC2_R[s,t] );
      ...
      otherValue_L[choice2_L[s,t]]   = sum( wProb_sC2_L[s,t] );
      otherValue_L[3-choice2_L[s,t]] = sum( wProb_oC2_L[s,t] );
